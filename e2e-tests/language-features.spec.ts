...
test(`should allow to change code and highlight code and AST nodes matching ESQuery selector`, async ({
	page,
}) => {
	await page.goto("/");

	// focus code editor textbox
	await page.getByLabel("Code Editor").getByRole("textbox").click();
